...
if (term(tl[i+1]["TOKEN_CLASS"],"relation")){
return false;
}
...
return walley_statements(tree,tl.slice(index_of_then+1,length_of_tl-1))&&end_stm(tree,TL_subtl(temp_tl,length_of_tl-1,length_of_tl));
     }
     var num_of_comma=0;
     var count_of_p=0;
